...
class Bloco:
    ...
    def __init__(self, numero, dados, hash_bloco_anterior, nonce=None, hash_deste_bloco=None):
        self.numero = numero
        self.dados = dados
    ...
    def minerar_bloco(self, numero_bloco, transacoes_do_bloco, hash_anterior, quantidade_zeros_prefixo):
        ...
        for nonce in range(MAX_NONCE):
            ...
            if hash_do_bloco.startswith(prefixo_hash):
                return Bloco(numero_bloco, transacoes_do_bloco, hash_anterior, nonce, hash_do_bloco)
